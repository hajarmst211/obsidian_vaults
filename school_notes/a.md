#### NLP Summary classifications:
- Extractive or Abstractive
- generic or query-focused
- supervised(SVM + labeled training data) or unsupervised
---
##### GA: Genetic Algorithm
![[Pasted image 20260711094615.png|900]]
...
By representing sentences as binary arrays, the algorithm iteratively generates and refines subsets of sentences—mimicking biological evolution—to find the optimal combination that maximizes coverage, relevance, and coherence while minimizing redundancy
...
GA: the [score function](https://www.sciencedirect.com/topics/computer-science/score-function) is trained by the [genetic algorithm](https://www.sciencedirect.com/topics/engineering/genetic-algorithm) (GA)
...
*  When LSA chose wrongly and most students chose correctly, it sometimes appeared to be because LSA is
more sensitive to contextual or paradigmatic associations and less to contrastive semantic or syntagmatic features. for example, LSA prefered nurse (cos = 0.47) of doctor (cos = 0.41) as association for physician. 
...
- Bi‑grams use 1 previous word, tri‑grams use 2 and N‑grams use N‑1
...
![[Pasted image 20260711135728.png]]
...
--> Respresenting the input document  as a Rich Semantic Graph where the nouns and verbs are represented as nodes and semantic realations as edges.
